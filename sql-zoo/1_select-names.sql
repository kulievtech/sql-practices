...
-- T his tutorial uses the LIKE operator to check names. We will be using the SELECT command on the table world:
...
SELECT name, REPLACE (capital, name, '') AS capital_extension
FROM world
